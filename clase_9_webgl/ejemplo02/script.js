window.onload = function()
{
	...
	var cuboUno = new THREE.CubeGeometry(200,200,200);
	var cuboDos = new THREE.CubeGeometry(100,100,100);
	var colorCubo = new THREE.MeshLambertMaterial({color: "pink"});
	var colorDos = new THREE.MeshLambertMaterial({color: "gray"});
	
	
	var texturaUno = THREE.ImageUtils.loadTexture( 'box_3.jpg' );
	...
	var cubo2 = new THREE.Mesh(cuboDos, colorDos);
	//Agregar materia...
	...
	*/
	...
	var materialUno = new THREE.MeshBasicMaterial({color: "yellow"});
	var materialDos = new THREE.MeshBasicMaterial({color: "blue"});
	*/
